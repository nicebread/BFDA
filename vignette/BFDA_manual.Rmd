...
Here are some plots for different settings of alpha for the two-sided case:
...
Here's a complete walkthrough for a one-sided (directional) correlation BF design analysis:
