...
s1 <- BFDA.sim(expected.ES=0.4, n.min=50, stepsize=5, n.max=300, type="t.paired", design="sequential", rscale=sqrt(2)/2, alternative="directional", cores=4)
s0 <- BFDA.sim(expected.ES=0, n.min=50, stepsize=5, n.max=300, type="t.paired", design="sequential", rscale=sqrt(2)/2, alternative="directional", cores=4)
