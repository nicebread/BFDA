...
sim.H1 <- BFDA.sim(expected.ES=0.5, type="t.between", prior=list("Cauchy", list(prior.location=0, prior.scale=1)), n.min=20, n.max=100, alternative="greater", boundary=Inf, B=100, verbose=TRUE, cores=4, stepsize = 10)

sim.H0 <- BFDA.sim(expected.ES=0, type="t.between", prior=list("Cauchy", list(prior.location=0, prior.scale=1)), n.min=20, n.max=100, alternative="greater", boundary=Inf, B=100, verbose=TRUE, cores=4, stepsize = 10)
```
...
s1 <- BFDA.sim(expected.ES=0.4, prior=list("t", list(prior.location=0, prior.scale=1, prior.df=10)), n.min=50, stepsize=5, n.max=300, type="t.paired", design="sequential", alternative="greater", B=100, cores=4, verbose=FALSE)
s0 <- BFDA.sim(expected.ES=0, prior=list("t", list(prior.location=0, prior.scale=1, prior.df=10)), n.min=50, stepsize=5, n.max=300, type="t.paired", design="sequential", alternative="greater", B=100, cores=4, verbose=FALSE)
...
s1 <- BFDA.sim(expected.ES=0.21, prior=list("stretchedbeta", list(prior.kappa=2)), n.min=50, stepsize=10, n.max=300, B=100, type="correlation", design="sequential", alternative="greater", cores=4, verbose=FALSE)
s0 <- BFDA.sim(expected.ES=0, prior=list("stretchedbeta", list(prior.kappa=2)), n.min=50, stepsize=10, n.max=100, B=300, type="correlation", design="sequential", alternative="greater", cores=4, verbose=FALSE)
