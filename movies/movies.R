...
makeMovie(BPA.0.5, n.start=30, n.stop=170, by=3, fname="GIF1", fps=10, boundary=10, xlim=c(10, 270), ylim=c(log(1/40), log(40)), traj.selection="fixed", dens.amplification=1.7, xextension=1.2, n.max.label.position="fixed", dens.right.offset=2, cex.labels=1.1, cex.annotations=0.95)